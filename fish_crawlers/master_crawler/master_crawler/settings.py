...
# Scrapy settings for master_crawler project
#
...
BOT_NAME = 'master_crawler'

SPIDER_MODULES = ['master_crawler.spiders']
NEWSPIDER_MODULE = 'master_crawler.spiders'

# Crawl responsibly by identifying yourself (and your website) on the user-agent
# USER_AGENT = 'master_crawler (+http://www.yourdomain.com)'
